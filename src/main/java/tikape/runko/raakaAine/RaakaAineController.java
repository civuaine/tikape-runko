...
public class RaakaAineController {
    ...
    public RaakaAineDao raakaAineDao;

    public RaakaAineController(Database database) {
        this.database = database;
        this.raakaAineDao = new RaakaAineDao(this.database);
    }

    public Route fetchAllRaakaAineet = (Request request, Response response) -> {

        Map<String, Object> model = new HashMap<>();
        List<RaakaAine> raakaAineet = this.raakaAineDao.findAll(); //Haetaan kaikki raakaAineet
        model.put("raakaAineet", raakaAineet); //Tallennetaan kaikki reseptit hakusanalle "raakaAineet"

        // mitähän tähän pitäisi tulla
    ...
    // onko näillä tässä alla enää käyttöä?
