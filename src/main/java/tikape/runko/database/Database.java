...
public class Database {
    ...
    private List<String> sqliteLauseet() {
        ...
        lista.add("CREATE TABLE Resepti (id SERIAL PRIMARY KEY NOT NULL, nimi varchar(255), valmistusaika integer, ohje varchar(1024));");
        lista.add("CREATE TABLE Raaka_aine (id SERIAL PRIMARY KEY NOT NULL, nimi varchar(255), UNIQUE(nimi));");
        ...
        lista.add("CREATE TABLE Kategoria (id SERIAL PRIMARY KEY NOT NULL, nimi varchar(255));");
